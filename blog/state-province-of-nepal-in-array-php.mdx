---
title: 'State/Province of Nepal in php array'
date: '2023-06-14'
tags: ['html', 'snippet']
draft: false
readTime: '1 min'
summary: 'State, province, district and municipality of nepal in php array code.'
---

## List of provinces of nepal in php array
...
```
## List of districts of nepal in php array
...
## List of municipality and vdc of nepal in php array
<div class="code-fixed-height">
```php
    array(
        array(
