...
images: ['/static/blogs/laragon.png']
---
...
![Laragon alternative of xampp](/static/blogs/laragon.png)
...
![Laragon multiple php verisons](/static/blogs/laragon-php-location.png)

![Laragon multiple php verisons](/static/blogs/laragon-php-version.png)
...
![Laragon phpmyadmin](/static/blogs/laragon-phpmyadmin.png)

![Laragon multiple database verisons](/static/blogs/laragon-database.png)




## Quick create app (Laravel, Wordpress ...)
![Laragon multiple php verisons](/static/blogs/laragon-laravel.png)
